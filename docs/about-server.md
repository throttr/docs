...
# Pull the image
docker pull ghcr.io/throttr/throttr:5.0.11-${T}-${V}-${A}-metrics-${M}

# Tag locally
docker tag ghcr.io/throttr/throttr:5.0.11-${T}-${V}-${A}-metrics-${M} throttr:local
...
services:
  throttr:
    image: ghcr.io/throttr/throttr:5.0.11-debug-uint16-amd64-metrics-enabled
    ports:
      - "9000:9000"
